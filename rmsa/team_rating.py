...
# Merge all types into a single frame
merged = control_rmts.merge(escort_rmts, on='team').merge(hybrid_rmts, on='team').merge(assault_rmts, on='team')

# Calculate a total rating
# In a 5 game match control is played twice which is why it is included twice in our total rating
