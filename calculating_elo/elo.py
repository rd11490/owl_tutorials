...
# Get a list of maps form the match frame
...
# determine the date of the match
...
def update_elo(elo, winner, team1, team2):
    ...
    elo[team1].append(elo1 + 50 * (s1-e1))
    elo[team2].append(elo2 + 50 * (s2-e2))
    return elo
